...
module.exports = async agent => {
  ...
  if (axiosPlus.agent) {
    ...
    agent.logger.info(`[egg-axios-plus] : The plugin took a total of ${intervalTime}ms to start in agent.js , Thank you for using egg-axios-plus and wish you a happy life`);
  }
